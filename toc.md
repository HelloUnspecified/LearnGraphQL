...
4. Why?
   ...
   _ Could be maturity of tools
   _ Could be maturity of content \* Community support, adoption
...
**notes** 1 structure setup overall such that we can easily reference and update it later. how can we overlay hindsight later. Things learned that invalidate past thinking.

1. System Requirements
   - node ( 14 )
     ** **note** can we do this without a bundler
   ...
   - supporting tools
     - insomnia, postman
       - **note** build out a set of insomnia, workspaces, plugins
   - github

2a
_ create an automated setup for folks.
_ homebrew
_ https://chocolatey.org/
_ npx
...
3. Setup Client Side
   ...
   - talk through the build pipeline **note** not as important as the server side
...
2. Overall Architecture
   ...
   1. What are the overall pieces of a GraphQL application
      _ query / mutation
      _ type system \* resolution
      **note** pull open a whiteboard and draw out how things actually work.
...
2. Understanding the Type System
   ...
   Extending our schema 1. Directives 1. Deprecation 2. Custom Scalars
...
2. Building our Schema
   ...
   _ Multiple Types
   _ Hierarchical Types
   _ Type Reuse
   _ custom Scalars
   _ query, mutations, field resolvers,
   _ directives
...
1. Arguments
   ...
   3. DataSources
   4. AST
2. Datasource managing
3. Hierarchical Resolvers
4. Field Resolvers
5. HOC on a resolver
